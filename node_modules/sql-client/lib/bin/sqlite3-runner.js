...
(function() {
  var HOMEDIR, LIB_COV, LIB_DIR, ObjectUtil, SQLRunner, SQLite3Client, SQLite3Runner, fs, path,
  ...
  SQLite3Runner = (function(superClass) {
    extend(SQLite3Runner, superClass);
    ...
    SQLite3Runner.prototype._get_options = function(additional) {
      ...
      return SQLite3Runner.__super__._get_options.call(this, ObjectUtil.merge(sqlite_opts, additional));
    };
    ...
    SQLite3Runner.prototype._stringify_results = function() {
      var rows, tail;
      rows = arguments[0], tail = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      if (rows != null) {
        return JSON.stringify(rows, null, 2);
      } else {
        return SQLite3Runner.__super__._stringify_results.apply(this, [rows].concat(slice.call(tail)));
      }
    };
