...
(function() {
  ...
  SQLite3ConnectionFactory = (function(superClass) {
    extend(SQLite3ConnectionFactory, superClass);
  ...
  SQLite3Client = (function(superClass) {
    extend(SQLite3Client, superClass);

    function SQLite3Client() {
      var options;
      options = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      SQLite3Client.__super__.constructor.apply(this, slice.call(options).concat([new SQLite3ConnectionFactory()]));
    }
  ...
  SQLite3ClientPool = (function(superClass) {
    extend(SQLite3ClientPool, superClass);

    function SQLite3ClientPool() {
      var options;
      options = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      SQLite3ClientPool.__super__.constructor.apply(this, slice.call(options).concat([new SQLite3ConnectionFactory()]));
    }
