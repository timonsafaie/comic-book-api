...
(function() {
  ...
  ObjectUtil = (function() {
    ...
    ObjectUtil.get_json_path = function() {
      var j, json, len, name, path;
      json = arguments[0], path = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      ...
      for (j = 0, len = path.length; j < len; j++) {
        name = path[j];
        json = json != null ? json[name] : void 0;
        if (json == null) {
          return null;
        }
      }
    ...
    ObjectUtil.get_funky_json_path = function() {
      var j, json, len, name, path, ref, ref1;
      json = arguments[0], path = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      if (typeof path === 'string') {
        path = [path];
      }
      ...
      for (j = 0, len = path.length; j < len; j++) {
        name = path[j];
        json = (ref = json[name]) != null ? ref : json["@" + name];
        if (json == null) {
          return null;
        }
      }
      return (ref1 = json != null ? json.$ : void 0) != null ? ref1 : json;
    };
